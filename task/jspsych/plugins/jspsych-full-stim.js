...
* Stephanie Campbell
*
* Plugin for door-and-button version of the novel 2-step task (2017).
*
**/
...
(function($) {
  jsPsych["full-stim"] = (function() {
	...
	if (state==0) {
	  if (String.fromCharCode(response[part].key)==choices[0]) {
	    // left response
	    choice1 = stims[0];
	  } else {
	    // right response
	    ...
	    // brown + green doors -> green/purple room
            if (color == 1) {
              state2 = 1;
            } else {
              state2 = 2;
	    ...
	    // blue + red doors -> yellow/red room
	    if (color == 1) {
              state2 = 2;
            } else {
              state2 = 1;
	...
	if (stage==-1) {
	  ...
	  display_element.append($('<div>', {
          ...
          display_element.append($('<div>', {
            style: 'background-image: url(img/3_'+face+'.png)',
            id: 'jspsych-top-stim',
          }));
          display_element.append($('<div>', {style: 'clear:both'}));
          display_element.append($('<div>', {
            style: 'background-image: url(img/shock_3.png)',
	...
	if (stage==3) {
	  ...
	  display_element.append($('<div>', {
	    style: 'background-image: url(img/'+shock+'_'+face+'.png)',
	    id: 'jspsych-top-stim',
	  }));
	  display_element.append($('<div>', {style: 'clear:both'}));
	  display_element.append($('<div>', {
